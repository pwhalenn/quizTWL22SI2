...
use App\Models\Masuk;  // Use the Masuk model
...
class dMasukSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Get random `kd_masuk` from the `masuks` table
        $kd_masuk_1 = Masuk::inRandomOrder()->first()->kd_masuk;
        $kd_masuk_2 = Masuk::inRandomOrder()->first()->kd_masuk;
        $kd_masuk_3 = Masuk::inRandomOrder()->first()->kd_masuk;
